...
if __name__ == '__main__':
    ...
    TOP.configure(background="#bb343a")
    TOP.title("BMI Application")
    TOP.resizable(width=False, height=False)
    LABLE = Label(TOP, bg="#771e23", text="Welcome to BMI Calculator", font=("Helvetica", 15, "bold"), pady=10)
    LABLE.place(x=55, y=0)
    LABLE1 = Label(TOP, bg="#771e23", text="Enter Weight (in kg):", bd=6,)
    LABLE1.place(x=55, y=60)
    ENTRY1 = Entry(TOP, bd=8, width=6, font="Roboto 11")
    ENTRY1.place(x=240, y=60)
    LABLE2 = Label(TOP, bg="#771e23", text="Enter Height (in cm):", bd=6,)
    LABLE2.place(x=55, y=121)
    ENTRY2 = Entry(TOP, bd=8, width=6, font="Roboto 11")
    ENTRY2.place(x=240, y=121)
    BUTTON = Button(bg="#771e23", bd=12, text="BMI", padx=33, pady=15, command=calculate_bmi,)
